...
import { WorkspaceAssetBrowser, AssetAttachment, type ContentAssetResponse } from '@/components/assets';
...
function TestAssetsContent() {
  ...
  const [attached, setAttached] = useState<ContentAssetResponse | null>(null);
