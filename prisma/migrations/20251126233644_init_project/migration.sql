-- CreateEnum
CREATE TYPE "WorkspaceRole" AS ENUM ('ADMINISTRATOR', 'MANAGER', 'DESIGNER', 'FACILITATOR', 'SME');

-- CreateEnum
CREATE TYPE "PageType" AS ENUM ('CUSTOM', 'NEEDS_ANALYSIS', 'TASK_ANALYSIS', 'AUDIENCE_PROFILE', 'LEARNING_OBJECTIVES', 'ASSESSMENT_PLAN', 'STORYBOARD', 'CURRICULUM_MAP');

-- CreateEnum
CREATE TYPE "BlockType" AS ENUM ('PARAGRAPH', 'HEADING_1', 'HEADING_2', 'HEADING_3', 'BULLETED_LIST', 'NUMBERED_LIST', 'CALLOUT', 'PERFORMANCE_PROBLEM', 'INSTRUCTIONAL_GOAL', 'TASK_STEP', 'LEARNING_OBJECTIVE', 'ASSESSMENT_IDEA');
...
-- CreateEnum
CREATE TYPE "DeliverableType" AS ENUM ('COURSE', 'MODULE', 'JOB_AID', 'REFERENCE_GUIDE', 'FACILITATOR_GUIDE', 'PARTICIPANT_GUIDE', 'NARRATION_SCRIPT', 'ASSESSMENT', 'STORYBOARD', 'OTHER');

-- CreateEnum
CREATE TYPE "DeliverableStatus" AS ENUM ('PLANNED', 'IN_PROGRESS', 'REVIEW', 'APPROVED', 'DELIVERED');
