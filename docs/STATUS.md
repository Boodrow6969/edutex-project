...
**Phase**: TipTap Storyboard Editor Development
**Current Sprint**: Milestone 1 Complete, Milestone 2 Next

---

## Current Focus: TipTap Storyboard Editor

### ✅ Milestone 1: TipTap Foundation - COMPLETE (January 4, 2026)

Replaced the frame-based Storyboard Designer with a TipTap-powered rich text editor.

**Delivered:**
- TipTap editor integration for STORYBOARD pages
- Block sync layer (`blocksToTipTap` / `tipTapToBlocks`)
- Autosave with 2-second debounce
- Markdown shortcuts (`#`, `-`, `1.`, `>`, triple backticks)
- Basic block types: Paragraph, Heading 1/2/3, Bullet List, Numbered List, Blockquote
...
**Dependencies Added:**
- `@tiptap/react`, `@tiptap/starter-kit`, `@tiptap/extension-placeholder`, `@tiptap/pm`
- `@tailwindcss/typography`

### 🎯 Milestone 2: Custom Block Nodes - NEXT

**Goal:** Add storyboard-specific blocks (STORYBOARD_METADATA, ELEARNING_SCREEN)

**Tasks:**
1. Update `prisma/schema.prisma` with new BlockType values
2. Create custom TipTap node extensions
3. Create React components for each block type
4. Create nested RichTextEditor for rich fields
5. Update sync.ts for new block types
...
**Tasks:**
1. Remaining node extensions (CHECKLIST, TABLE, FACILITATOR_NOTES, MATERIALS_LIST)
2. Block picker modal with slash command trigger
3. Objective import functionality
...
**Tasks:**
1. Lazy migration from STORYBOARD_FRAME to ELEARNING_SCREEN
2. Remove old storyboard components
